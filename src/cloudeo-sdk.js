...
(function() {
  ...
  CDO.getInstallerURL = function(responder, updateDescriptorUrl) {
    try {
      ...
      if(updateDescriptorUrl === undefined) {
        updateDescriptorUrl = CDO._platformOptions.installationDescriptorRoot + CDO._UPDATE_DESCRIPTOR_NAME + CDO._getUpdateDescriptorSuffix() + ".js"
      }
  ...
  CDO._getUpdateDescriptorSuffix = function() {
    ...
    if(/Windows/.test(ua)) {
      ...
      if(/(Intel Mac OS X 10_[6-8])|(Intel Mac OS X 10.[6-8])/.test(ua)) {
        suffix = ".mac"
      }else {
        if(/Intel Mac OS X 10_5/.test(ua)) {
          suffix = ".mac105"
        }
      }
    }
...
(function() {
  ...
  CDO.CloudeoPlugin.prototype.update = function(listener, url) {
    ...
    if(!url) {
      url = CDO._platformOptions.updateDescriptorRoot + CDO._UPDATE_DESCRIPTOR_NAME + CDO._getUpdateDescriptorSuffix()
    }
...
(function() {
  ...
  CDO.CloudeoService.prototype.getConnectedUsers = function(responder, scopeId, token) {
    ...
    var url = CDO._getStreamerEndpoint(scopeId) + "/" + _wrapScopeId(scopeId);
...
(function() {
  var _DEFAULT_PLATFORM_INIT_OPTIONS = {pluginPollFrequency:500, initDevices:true, skipUpdate:false, updateDescriptorRoot:"", installationDescriptorRoot:""};
  ...
  CDO.initPlatform = function(listener, optionsOrClientId) {
    ...
    CDO._platformOptions.updateDescriptorRoot = CDO._PLUGIN_UPDATE_ROOT;
    CDO._platformOptions.installationDescriptorRoot = CDO._PLUGIN_INSTALL_ROOT;
    ...
    if(pluginInstalled) {
      if(CDO._platformOptions.skipUpdate) {
        CDO._logw("Cloudeo Plug-in update was skipped. Do this only if you " + "know what you're doing.");
  ...
  CDO.disposePlatform = function() {
    ...
    var pContainer = document.getElementById(CDO._pluginContainerId);
  ...
  function _getInstallURL(listener) {
    ...
    var installUpdateDescriptor = CDO.getInstallerURL(CDO.createResponder(succHandler, errHandler))
  }
  ...
  function _initDevices(listener) {
    ...
    var stateChangedEvent = new CDO.InitStateChangedEvent(CDO.InitState.INITIALIZED);
  ...
  function _configDeviceOfType(devType, storageProperty, stepComplete) {
    ...
    var devFunctionalLabel = devType.substring(0, 1).toLowerCase() + devType.substring(1);
    CDO._service[getNamesMethod](CDO.createResponder(function(devs) {
      ...
      CDO._service[setMethod](CDO.createResponder(function() {
...
(function() {
  ...
  CDO._getStreamerEndpoint = function(scopeId) {
    if(CDO._CLIENT_ENDPOINTS[CDO._clientId] === undefined) {
      CDO._logw("Failed to find a streamer endpoint for client");
...
(function() {
  CDO.RELEASE_LEVEL = "stable";
  CDO.VERSION = "1.17.4";
  CDO._DEFAULT_STREAMER_ENDPOINT = "67.228.150.188:443";
  CDO._PLUGIN_UPDATE_ROOT = "http://s3.amazonaws.com/api.cloudeo/stable/";
  CDO._PLUGIN_INSTALL_ROOT = "https://s3.amazonaws.com/api.cloudeo/stable/"
})();
(function() {
  CDO._CLIENT_ENDPOINTS = {1:"67.228.150.188:443", 2:"67.228.150.188:443", 3:"174.127.76.173:443", 4:"67.228.150.188:443", 5:"67.228.150.188:443", 6:"67.228.150.188:443", 7:"67.228.150.188:443"}
})();
